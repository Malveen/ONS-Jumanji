...
public class StepDefinition {
	...
	public void he_fills_out_the_survey() throws Throwable {
		driver.findElement(By.id("question1Textbox")).sendKeys("180"); //type in textbox value //TODO: Bad practise, always input values
		driver.findElement(By.id("question1Submit ")).click(); //space due to id error 
		driver.findElement(By.id("question2Textbox")).sendKeys("360");//TODO: Bad practise, always input values
